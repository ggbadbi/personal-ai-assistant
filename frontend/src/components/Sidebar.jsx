        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                <div style={{ fontSize: '14px', fontWeight: 700, color: 'var(--teal-bright)' }}>Knowledge Graph</div>
                <div style={{ fontSize: '10px', color: 'var(--text-muted)', fontFamily: 'JetBrains Mono' }}>Visual map of your knowledge connections</div>
              </div>
            </div>
            <button onClick={() => setGraphOpen(false)} style={{
              background: 'rgba(255,107,107,0.1)', border: '1px solid rgba(255,107,107,0.3)',
              borderRadius: '8px', padding: '6px 14px',
              color: '#ff6b6b', cursor: 'pointer', fontSize: '13px', fontFamily: 'Outfit'
            }}>
              ✕ Close
            </button>
          </div>
